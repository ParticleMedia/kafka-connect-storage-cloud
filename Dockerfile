...
RUN sudo mkdir -p /usr/local/share/kafka/plugins
RUN sudo cp -r /usr/share/confluent-hub-components/confluentinc-kafka-connect-hdfs/* /usr/local/share/kafka/plugins/
...
RUN sudo cp /usr/share/confluent-hub-components/hudi-kafka-connect/hudi-kafka-connect-bundle-0.12.1-amzn-0.jar /usr/local/share/kafka/plugins/lib/hudi-kafka-connect-bundle-0.12.1-amzn-0.jar
RUN sudo cp /usr/share/confluent-hub-components/hudi-kafka-connect/aws-java-sdk-bundle-1.11.271.jar /usr/local/share/kafka/plugins/lib/aws-java-sdk-bundle-1.11.271.jar
